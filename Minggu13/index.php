    ...
    <div class="container mt-4">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <div class="modal fade" id="hapusModal<?= $row["id"] ?>" tabindex="-1" role="dialog" aria-labelledby="modalLabel<?= $row["id"] ?>" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="modalLabel<?= $row["id"] ?>">Konfirmasi Hapus</h5>
